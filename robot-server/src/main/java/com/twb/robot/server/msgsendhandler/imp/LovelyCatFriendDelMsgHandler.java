...
public class LovelyCatFriendDelMsgHandler extends BaseLovelyCatMsgSendHandler{

	public LovelyCatFriendDelMsgHandler(IMessageSendHandler messageSendHandler) {
