...
public class LovelyCatExtMsgLoggedRobotHandler extends BaseLovelyCatMsgSendHandler{

	public LovelyCatExtMsgLoggedRobotHandler(IMessageSendHandler messageSendHandler) {
