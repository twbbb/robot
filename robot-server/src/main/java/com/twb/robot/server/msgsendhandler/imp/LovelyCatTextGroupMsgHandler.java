...
public class LovelyCatTextGroupMsgHandler extends BaseLovelyCatMsgSendHandler{

	public LovelyCatTextGroupMsgHandler(IMessageSendHandler messageSendHandler) {
